              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input
                    ...
                    name="event-name"
                    type="text"
                    className="block dark:text-gray-900 bg-gray-200 max-w-lg w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-sky-500 dark:focus:border-sky-500 sm:text-sm border border-gray-300 rounded-md"
                    required
                    value={eventName}
                ...
                <div className="mt-1 sm:mt-0 flex flex-wrap sm:flex-nowrap gap-2">
                  <div className="w-1/2">
                    <input
                      ...
                      name="date"
                      type="date"
                      className="max-w-lg dark:text-gray-900 block bg-gray-200  focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-sky-500 dark:focus:border-sky-500 w-full shadow-sm sm:max-w-xs sm:text-sm border border-gray-300 rounded-md"
                      required
                      value={eventDate}
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <input
                    ...
                    name="event-link"
                    type="text"
                    className="max-w-lg dark:text-gray-900 bg-gray-200 block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-sky-500 dark:focus:border-sky-500 sm:text-sm border border-gray-300 rounded-md"
                    required
                    value={eventLink}
              ...
              <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:pt-5">
                ...
                <div className="mt-1 sm:mt-0 sm:col-span-2">
                  <textarea
                    ...
                    name="about"
                    rows={10}
                    className="max-w-lg dark:text-gray-900 bg-gray-200  shadow-sm block w-full focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-sky-500 dark:focus:border-sky-500 sm:text-sm border border-gray-300 rounded-md"
